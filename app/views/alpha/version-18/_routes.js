...
router.post('/route-create-contact', function(req,res){
    ...
    if (received == "RINA") {
        res.redirect('/alpha/version-18/submissions/initial-claim/01-create/rina/01-type')
        }
    else {
        res.redirect('/alpha/version-18/submissions/initial-claim/01-create/index')
    }
})
...
router.post('/route-create-type', function(req,res){
    ...
    var articleType = req.session.data['article-type']
        if (claimType == "Actual cost - Sickness" || claimType == "Actual cost - Accident at work") {
            res.redirect('/alpha/version-18/submissions/initial-claim/01-create/rina/02a-actual')
            }

        else if (claimType == "Average cost - Sickness") {
            if (articleType == "Article 63 (2a)" || articleType == "Article 63 (2b)") {
                res.redirect('/alpha/version-18/submissions/initial-claim/01-create/rina/02b-average-63')
                }
            else if (articleType == "Article 94" || articleType == "Article 95") {
                res.redirect('/alpha/version-18/submissions/initial-claim/01-create/rina/02c-average-94-95')
                }
            else {
                    res.redirect('/alpha/version-18/submissions/initial-claim/01-create/rina/01-type')
                }
...
router.post('/route_decision_1003912', function(req,res){
    ...
    if (decision1003912 == "partial") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/10c-20001542-months')
        }
    else {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/10b-20001542-decision')
    }
})
...
router.post('/route_credit_amount_1003911', function(req,res){
    ...
    if (withdraw1003911 == "both") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/04c-20001563-months')
        }
    else {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/04b-20001563-withdraw')
    }
})
...
router.post('/route_decision_1003911', function(req,res){
    ...
    if (decision1003911 == "accept") {
        ...
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/04b-20001563-decision')
    }
})
...
router.post('/route_non_rina_open', function(req,res){
    ...
    if (open == "yes") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/03-active-average')
        }
    else if (open == "no") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/01c-pending-average')
        }
    else {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/02-open-confirmation')
    }
})
...
router.post('/route_adding_complete', function(req,res){
    ...
    if (complete == "yes") {
        ...
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/01-pending-average')
        }
    else {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/non-rina/01b-adding-confirmation')
    }
})
...
router.post('/route_decision_1003844', function(req,res){
    ...
    if (decision1003842 == "accept") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/rina/11c-003-cya')
        }
    else {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/rina/11b-003-decision')
    }
})
...
router.post('/route_decision_1003842', function(req,res){
    var decision1003842 = req.session.data['decision']
    if (decision1003842 == "accept") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/rina/04c-001-cya')
        }
    else {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/rina/04b-001-decision')
    }
})
...
router.post('/route_rina_open', function(req,res){
    var open = req.session.data['open']
    if (open == "yes") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/rina/03a-active-actual-processing')
        }
    else if (open == "no") {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/rina/01b-pending-actual')
        }
    else {
        res.redirect('/alpha/version-18/submissions/credit-note/03-process/rina/02-open-confirmation')
    }
})
...
router.post('/route_create_new_submission_6799', function(req,res){
    ...
    if (submissionType == "Contestation") {
        res.redirect('/alpha/version-18/claims/non-rina/actual-cost/france/6799/submissions/create/reply-to-contestation/01-details')
        }
        else if (submissionType == "Credit note") {
            res.redirect('/alpha/version-18/claims/non-rina/actual-cost/france/6799/submissions/create/credit-notes/01-details')
            }
    else {
        res.redirect('/alpha/version-18/claims/non-rina/actual-cost/france/6799/submissions/create/index')
    }
})
...
router.post('/route_create_new_submission_6784', function(req,res){
    var submissionType = req.session.data['type']
    if (submissionType == "Contestation") {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/submissions/create/02a-contestation-actual')
        }
        else if (submissionType == "Credit note") {
            res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/submissions/create/02b-credit-note-actual')
            }
    else {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/submissions/create/01-submission-type')
    }
})
...
router.post('/route-20001288-mark-complete', function(req,res){
    ...
    if (ageBracket == "0 to 19 years" || ageBracket == "20 to 64 years" || ageBracket == "65 years and over") {
        res.redirect('/alpha//version-18/claims/rina/average-cost/spain/5422/invoices/20001288/02-confirmation')
        }
    else {
        ...
        if (accepted == "0") {
            ...
            res.redirect('/alpha//version-18/claims/rina/average-cost/spain/5422/invoices/20001288/01b-to-check-error')
        }
    }
...
router.post('/route-claim-search', function(req,res){
    ...
    if (claimId == "6784" || claimId == "7399") {
        res.redirect('/alpha/version-18/claims/search/individual-claim')
        }
    else {
        res.redirect('/alpha/version-18/claims/search/no-results')
    }
})
...
router.post('/route-contact-method', function(req,res){
    ...
    if (received == "RINA" ||  received == "Paper") {
        res.redirect('/alpha/version-18/claims/create/type')
        }
    else {
        res.redirect('/alpha/version-18/claims/create/index')
    }
})
...
router.post('/route-create-claim', function(req,res){
    ...
    if (received == 'RINA') {
        ...
        if (claimType == "Actual cost - Sickness" || claimType == "Actual cost - Accident at work") {
            res.redirect('/alpha/version-18/claims/create/details-rina-actual')
            }

        else if (claimType == "Average cost - Sickness") {
            if (articleType == "Article 63 (2a)" || articleType == "Article 63 (2b)") {
                res.redirect('/alpha/version-18/claims/create/details-rina-average-63')
                }
            else if (articleType == "Article 94" || articleType == "Article 95") {
                res.redirect('/alpha/version-18/claims/create/details-rina-average-94-95')
                }
            else {
                    res.redirect('/alpha/version-18/claims/create/type')
                }
        ...
        if (claimType == "Actual cost - Sickness" || claimType == "Actual cost - Accident at work") {
            res.redirect('/alpha/version-18/claims/create/details-paper-actual')
            }

        else if (claimType == "Average cost - Sickness") {
            if (articleType == "Article 63 (2a)" || articleType == "Article 63 (2b)") {
                res.redirect('/alpha/version-18/claims/create/details-paper-average-63')
                }
            else if (articleType == "Article 94" || articleType == "Article 95") {
            res.redirect('/alpha/version-18/claims/create/details-paper-average-94-95')
            }
            else {
                res.redirect('/alpha/version-18/claims/create/type')
            }
    ...
    if (received == 'RINA') {
        if (article == "Article 62 - Sickness" || article == "Article 62 - Accident at work") {
            res.redirect('/alpha/version-18/claims/create/details-rina-actual')
                ...
                res.redirect('/alpha/version-18/claims/create/article-type')
            }
            }
...
router.get("/claims/create/cancel-confirmation", (req, res)=> {
    res.render("alpha/version-18/claims/create/cancel-confirmation", {referer: req.headers.referer});
});
...
router.post('/route-cancel-create-claim', function(req,res){
    ...
    if (cancel == "yes" ) {
        res.redirect('/alpha/version-18/claims/index')
    } else if (cancel == "no"){
        return res.redirect(back)
    } else {
        res.redirect('/alpha/version-18/claims/create/cancel-confirmation')
    }
...
router.post('/route-upload-method', function(req,res){
    ...
    if (method == "RINA" ) {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/index')
        }
    else {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/index')
    }
...
router.get("/claims/invoices/upload/cancel-confirmation", (req, res)=> {
    res.render("alpha/version-18/claims/invoices/upload/cancel-confirmation", {referer: req.headers.referer});
});
...
router.post('/route-cancel-upload-invoices', function(req,res){
    ...
    if (cancel == "yes" ) {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/summary/not-started')
    } else if (cancel == "no"){
        return res.redirect(back)
    } else {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/cancel-confirmation')
    }
...
router.get("/claims/invoices/upload/delete-confirmation", (req, res)=> {
    res.render("alpha/version-18/claims/invoices/upload/delete-confirmation", {referer: req.headers.referer});
});
...
router.post('/route-delete-invoice-file', function(req,res){
    ...
    if (cancel == "yes" ) {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/index?show-back=No')
    } else if (cancel == "no"){
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/cya')
    } else {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/delete-confirmation')
    }
...
router.get("/claims/invoices/upload/xml/additional-delete-confirmation", (req, res)=> {
    res.render("alpha/version-18/claims/invoices/upload/xml/additional-delete-confirmation", {referer: req.headers.referer});
});
...
router.post('/route-delete-invoice-additional-file', function(req,res){
    ...
    if (cancel == "yes" ) {
        res.redirect('/alpha/version-18/claims/invoices/upload/xml/additional-bulk-upload')
    } else if (cancel == "no"){
        return res.redirect(back)
    } else {
        res.redirect('/alpha/version-18/claims/invoices/upload/delete-confirmation')
    }
...
router.get('/claims/create/cya', function(req, res) {
    ...
    res.render('alpha/version-18/claims/create/cya', {fullSubmissionMonth: fullSubmissionMonth, fullTargetMonth: fullTargetMonth});
})
...
router.post('/create-claim-validation', function(req,res){
    ...
    if (
        ...
        {
        res.redirect('/alpha/version-18/claims/create/error')
        }
    else {
        res.redirect('/alpha/version-18/claims/create/cya')
    }
...
router.post('/route_delete_claim', function(req,res){
    ...
    if (confirmation == "yes" ) {
        res.redirect('/alpha/version-18/post-mvp/claim-summary/delete-confirmation')
        }
    else if (confirmation == "no"){
            res.redirect('/alpha/version-18/post-mvp/claim-summary/not-started')
            }
    else {
        res.redirect('/alpha/version-18/post-mvp/claim-summary/delete-check')
    }
...
router.post('/route-additional-upload', function(req,res){
    ...
    if (upload == "yes" ) {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/index-additional-file')
        }
    else if (upload == "no"){
            res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/cya')
            }
    else {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/additional-file')
    }
...
router.post('/route-additional-invoice', function(req,res){
    ...
    if (type == "bulk" ) {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/xml/additional-bulk-upload')
        }
    else if (type == "single"){
            res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/create/index')
            }
    else {
        res.redirect('/alpha/version-18/claims/rina/actual-cost/6784-france/invoices/upload/options')
    }
...
router.post('/route-additional-upload-2', function(req,res){
    ...
    if (upload == "yes" ) {
        res.redirect('/alpha/version-18/claims/invoices/upload/xml/additional-bulk-upload')
            ...
            res.redirect('/alpha/version-18/claims/invoices/upload/xml/additional-bulk-cya')
            }
    else {
        res.redirect('/alpha/version-18/claims/invoices/upload/xml/additional-file-2')
    }
...
router.get('/claims/summary/not-started', function(req, res) {
    ...
    res.render('alpha/version-18/claims/summary/not-started', { targetDateEditFormatted: targetDateEditFormatted, targetDateFormatted: targetDateFormatted });
})
...
router.post('/personSearch', (req, res) => {
    ...
    fs.readFile(jsonDataPath, (err, data) => {
      ...
      res.render('version-18/claims/invoices/details/person-not-found/s1-default-search-results', { searchResults: filteredResults });
    });
  });
