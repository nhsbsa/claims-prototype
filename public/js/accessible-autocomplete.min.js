(function webpackUniversalModuleDefinition(e, t) {
  ...
  return function (n) {
    ...
    var k = [],
      ...
      L = !1;
    function T() {
      for (var e; e = k.pop();) E.afterMount && E.afterMount(e), e.componentDidMount && e.componentDidMount();
    }
    ...
    function D(e, t, n, r, o) {
      ...
      return !L && c && 1 === c.length && "string" == typeof c[0] && null != s && s.splitText !== undefined && null == s.nextSibling ? s.nodeValue != c[0] && (s.nodeValue = c[0]) : (c && c.length || null != s) && function S(e, t, n, r, o) {
        ...
        if (0 !== y) for (var g = 0; g < y; g++) {
          ...
          l = D(l, s, n, r), a = c[g], l && l !== e && l !== a && (null == a ? e.appendChild(l) : l === a.nextSibling ? I(a) : e.insertBefore(l, a));
        }
        var x, O, C;
    ...
    function F(e, t) {
      var n = e._component;
      n ? q(n) : (null != e["__preactattr_"] && e["__preactattr_"].ref && e["__preactattr_"].ref(null), !1 !== t && null != e["__preactattr_"] || I(e), h(e));
    }
    function h(e) {
      for (e = e.lastChild; e;) {
    ...
    function V(e, t, n, r) {
      if (!e._disable) {
        ...
        for (!d || n ? k.unshift(e) : y || (e.componentDidUpdate && e.componentDidUpdate(c, p, g), E.afterUpdate && E.afterUpdate(e)); e._renderCallbacks.length;) e._renderCallbacks.pop().call(e);
        P || r || T();
      }
    }
    function q(e) {
      ...
      var n = e._component;
      n ? q(n) : t && (t["__preactattr_"] && t["__preactattr_"].ref && t["__preactattr_"].ref(null), I(e.nextBase = t), m.push(e), h(t)), e.__ref && e.__ref(null);
    }
    function g(e, t) {
    ...
    var a = function (n) {
      ...
      return t.isQueryAnOption = function (e, t) {
        ...
        var e,
          ...
          T = n + "__input",
          B = null !== b ? " " + T + "--focused" : "",
          D = this.props.showAllValues ? " " + T + "--show-all-values" : " " + T + "--default",
          ...
          Q = K && 0 === K.toLowerCase().indexOf(C.toLowerCase()) && N ? C + K.substr(C.length) : "",
          z = u + "__assistiveHint",
          G = E ? {
            "aria-describedby": z
          } : null;
        return c && "string" == typeof (e = y({
          ...
          var n = (-1 === b ? S === t : b === t) && null === w ? " " + W + "--focused" : "",
            r = t % 2 ? " " + W + "--odd" : "",
            o = Z() ? "<span id=" + u + "__option-suffix--" + t + ' style="border:0;clip:rect(0 0 0 0);height:1px;marginBottom:-1px;marginRight:-1px;overflow:hidden;padding:0;position:absolute;whiteSpace:nowrap;width:1px"> ' + (t + 1) + " of " + O.length + "</span>" : "";
