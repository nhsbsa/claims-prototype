...
!function () {
  ...
  }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof global && global || {}), s.prototype.t = function (t, e) {
  ...
  function d(t, i) {
    ...
    }), this.maxLength = 1 / 0, "maxwords" in this.config && this.config.maxwords) this.maxLength = this.config.maxwords;else {
  ...
  d.prototype.init = function () {
    ...
    if (this.$module && this.$inputs) {
      ...
      }), window.addEventListener("onpageshow" in window ? "pageshow" : "DOMContentLoaded", this.syncAllConditionalReveals.bind(this)), this.syncAllConditionalReveals(), e.addEventListener("click", this.handleClick.bind(this));
    }
  ...
  v.prototype.initUpdateSpan = function () {
    ...
    if (i && o && s) {
      o.setAttribute("role", "tablist"), t(s, function (t) {
        ...
        e.setAttributes(t), t.addEventListener("click", e.boundTabClick, !0), t.addEventListener("keydown", e.boundTabKeydown, !0), e.hideTab(t);
      });
    ...
    i && o && s && (o.removeAttribute("role"), t(s, function (t) {
      ...
      t.removeEventListener("click", e.boundTabClick, !0), t.removeEventListener("keydown", e.boundTabKeydown, !0), e.unsetAttributes(t);
    ...
    i && new m(i, e.errorSummary).init(), t(n.querySelectorAll('[data-module="govuk-exit-this-page"]'), function (t) {
      new v(t, e.exitThisPage).init();
    });
    var o = n.querySelector('[data-module="govuk-header"]');
    o && new b(o).init(), t(n.querySelectorAll('[data-module="govuk-notification-banner"]'), function (t) {
    ...
    s && new w(s).init(), t(n.querySelectorAll('[data-module="govuk-tabs"]'), function (t) {
      new E(t).init();
    });
  }({
    errorSummary: {
